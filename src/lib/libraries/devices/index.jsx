...
import scratchstarIconURL from './scratchstar/scratchstar.png';
import scratchstarConnectionIconURLL from './scratchstar/scratchstar-illustration.svg';
import scratchstarConnectionSmallIconURL from './scratchstar/scratchstar-small.svg';
...
const deviceData = [
    ...
    {
        name: 'Scratch Star',
        deviceId: 'scratchstar',
        manufactor: 'Stemstar',
        learnMore: 'https://code.stemstar.com',
        type: DeviceType.arduino,
        iconURL: scratchstarIconURL,
        description: (
            <FormattedMessage
                defaultMessage="Scratch Star."
                description="Description for scratchstar device"
                id="gui.device.scratchstar.description"
            />
        ),
        featured: true,
        disabled: false,
        ...
        useAutoScan: false,
        connectionIconURL: scratchstarConnectionIconURLL,
        connectionSmallIconURL: scratchstarConnectionSmallIconURL,
        connectingMessage: (
            <FormattedMessage
